...
//This is the function/event that overrides the FOV at the start - ME
// PLAN B: replace both UpdateEyeHeight events in both PlayerPawn and in DeusExPlayer
event UpdateEyeHeight(float DeltaTime)
{
	FOVAngle = CinFOV;

	//This overrides the FOV changing in the playerpawn
	DesiredFOV = CinFOV;
