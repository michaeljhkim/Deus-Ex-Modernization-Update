...
defaultproperties
{
     ...
     clientTextures(0)=Texture'RF.UserInterface.RFMenuLoadSaveBackground_1'
     clientTextures(1)=Texture'RF.UserInterface.RFMenuLoadSaveBackground_2'
     clientTextures(2)=Texture'RF.UserInterface.RFMenuLoadSaveBackground_3'
     clientTextures(3)=Texture'RF.UserInterface.RFMenuLoadSaveBackground_4'
     clientTextures(4)=Texture'RF.UserInterface.RFMenuLoadSaveBackground_5'
     clientTextures(5)=Texture'RF.UserInterface.RFMenuLoadSaveBackground_6'
}
