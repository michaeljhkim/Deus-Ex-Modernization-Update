...
//=============================================================================
class RFRootWindow extends DeusExRootWindow;
...
event ModifyNewChild(Window NewParent, Window NewKidOnTheBlock )
{
	...
	switch (NewKidOnTheBlock.Class.Name)
	{
		...
		case 'MenuScreenDisplay':
			MenuScreenDisplay(NewKidOnTheBlock).choices[4] = Class'RF.RFMenuChoice_FOV';
			MenuScreenDisplay(NewKidOnTheBlock).choices[8] = Class'RF.RFMenuChoice_UIScaling';
			break;
		case 'menuchoice_class':
			MenuChoice_Class(NewKidOnTheBlock).ClassClasses[0] = "RF.RFJCDentonMale";
		default:
			processed = False;
			break;
	}
